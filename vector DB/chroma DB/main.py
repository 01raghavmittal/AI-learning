...
def setup_chromadb(text_vector, document_chunk, user_input=None):
...
def main():
    ...
    user_input="tell me payload of model list price API"
    db_response = setup_chromadb(document_chunk=chunks,text_vector=vectors,user_input=user_input)
    ...
    format_prompt= format_userquery(user_query=user_input, response = db_response)
